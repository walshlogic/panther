...
function getExistingVisitCodeData($index)
{
...
<body id="page-top">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="form-container">
                            ...
                            <form action="set_visit_code_add_process.php"
                                method="post">
                                <input type="hidden"
                                    name="id"
                                ...
                                <input type="submit"
                                    ...
                                    class="button">
                                <button type="button"
                                    onclick="location.href='set_visit_codes.php'"
    ...
    window.onload = function() {
        document.getElementById('visitCodes').focus();
    };
    </script>
    <script>
