...
$screenTitle = "ADMIN | JOB TITLE MANAGER";
$screenTitleMidText = "";
...
$jobTitlesData = $editing ? getExistingJobTitlesData($_GET['edit']) : ['', '', ''];

// Function to retrieve existing data from CSV based on the given ID
function getExistingJobTitlesData($id)
{
    $filePath = './data/jobTitles.csv';
...
// Check if editing an existing job titles
$editing = isset($_GET['edit']);
if ($editing) {
    $jobTitlesData = getExistingJobTitlesData($_GET['edit']);
} else {
    $jobTitlesData = ['', '', ''];
}
?>
...
<head>
    ...
    <title>PANTHER | Job Titles</title>
...
<body id="page-top">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="form-container">
                            ...
                            <form action="sys_job_process.php"
                                method="post"
                                onsubmit="return validateForm()">
                                <input type="hidden"
                                    name="id"
                                    value="<?php echo htmlspecialchars($jobTitlesData[0]); ?>">
                                <div class="form-group">
                                    ...
                                    <div class="input-container">
                                        <input type="text"
                                            id="jobTitle"
                                            name="jobTitle"
                                            value="<?php echo $jobTitlesData[1]; ?>"
                                            autocomplete="off">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="checkbox-container">
                                        <div class="checkbox-align">
                                            <input type="checkbox"
                                                id="active"
                                                name="active"
                                                <?php echo $jobTitlesData[2] ? 'checked' : ''; ?>
                                                value="1">
                                        </div>
                                    </div>
                                </div>
                                <div class="button-container">
                                    <input type="submit"
                                        value="<?php echo $editing ? 'UPDATE JOB TITLE' : 'ADD JOB TITLE'; ?>"
                                        class="button">
                                    <button type="button"
                                        onclick="location.href='sys_job_manager.php'"
    ...
    <script>
        function clearFormFields() {
            ...
            // Set focus to the 'job title' textbox
            document.getElementById('jobTitle').focus();
        }

        function validateForm() {
            // Get the value of the "jobTitle" textbox
            ...
            // If the "Job Title" is not empty, allow the form to be submitted
            return true;
        }
    </script>
