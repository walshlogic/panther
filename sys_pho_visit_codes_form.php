...
$screenTitle = "ADMIN | PHOTO MANAGER - VISIT CODES";
$screenTitleMidText = "";
...
$visitCodeData = $editing ? getExistingVisitCodeData($_GET['edit']) : ['', '', '', ''];
...
<head>
    ...
    <title>PANTHER | Visit Codes</title>
...
<body id="page-top">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="form-container">
                            ...
                            <form action="sys_pho_visit_codes_process.php"
                                method="post"
                                onsubmit="return validateForm()">
                                <input type="hidden"
                                    name="id"
                                    value="<?php echo htmlspecialchars($visitCodeData[0]); ?>">
                                ...
                                <div class="button-container">
                                    <input type="submit"
                                        value="<?php echo $editing ? 'UPDATE VISIT CODE' : 'ADD VISIT CODE'; ?>"
                                        class="button">
                                    <button type="button"
                                        onclick="location.href='sys_pho_visit_codes.php'"
    ...
    <script>
        function clearFormFields() {
            ...
            // Set focus to the 'visitCode' textbox
            document.getElementById('visitDescription').focus();
        }
        ...
        function validateForm() {
            ...
            if (visitDescription.trim() === '') {
                ...
                Swal.fire({
                    ...
                    text: 'Visit Description Cannot Be Empty.',
                    icon: 'error',
                });
                // Prevent the form from being submitted
                return false;
            }
            // If the "visitDescription" is not empty, allow the form to be submitted
            return true;
        }
    </script>
